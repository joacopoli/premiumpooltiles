  ...
  return (
    <div className="pt-32 pb-24 bg-white">
      <div className="max-w-6xl mx-auto px-6">
        <div className="mb-16">
          <span className="text-rose-700 font-bold uppercase tracking-[0.4em] text-[10px] mb-4 block">Engineering Excellence</span>
          <h1 className="text-4xl font-bold text-slate-900 uppercase tracking-tight mb-4">Technical Specifications</h1>
          <div className="w-16 h-1 bg-rose-900 mb-8"></div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {specs.map((spec, i) => (
            <div key={i} className="p-8 border border-slate-100 rounded-sm bg-slate-50 hover:border-rose-200 transition-all">
              ...
              <p className="text-rose-700 font-medium text-lg">{spec.value}</p>
            </div>
          ))}
        </div>
