  ...
  return (
    <div className="pt-32 pb-24 bg-white">
      <div className="max-w-4xl mx-auto px-6">
        <div className="mb-16">
          <span className="text-rose-700 font-bold uppercase tracking-[0.4em] text-[10px] mb-4 block">Logistics Excellence</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          <div className="space-y-8">
            <h2 className="text-lg font-bold uppercase tracking-widest text-slate-900 border-b-2 border-rose-700 pb-2 inline-block">Premium Shipping</h2>
            <div className="space-y-4">
              <div className="flex gap-4">
                <div className="w-10 h-10 rounded-full bg-rose-50 flex items-center justify-center shrink-0">🚛</div>
                <div>
              ...
              <div className="flex gap-4">
                <div className="w-10 h-10 rounded-full bg-rose-50 flex items-center justify-center shrink-0">🛡️</div>
                <div>
          ...
          <div className="space-y-8">
            <h2 className="text-lg font-bold uppercase tracking-widest text-slate-900 border-b-2 border-rose-700 pb-2 inline-block">Return Policy</h2>
            <div className="space-y-4">
              <div className="flex gap-4">
