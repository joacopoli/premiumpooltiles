      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-10 w-full text-white pt-20 md:pt-0">
        <div className="max-w-3xl">
          <h1 className="text-4xl sm:text-6xl md:text-8xl font-bold leading-[1.1] mb-6 tracking-tighter">
            Transforming Backyards <br/><span className="text-rose-700 italic font-medium">into Paradise</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <a 
              href="#collections" 
              className="bg-white text-slate-950 px-8 py-5 text-center font-bold uppercase tracking-widest transition-all rounded-sm shadow-2xl min-h-[60px] flex items-center justify-center hover:bg-rose-800 hover:text-white"
            >
              Collections
            </a>
            <a 
