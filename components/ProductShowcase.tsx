    ...
    <section id="collections" className="py-24 bg-slate-50 overflow-hidden scroll-mt-24">
      <div className="max-w-7xl mx-auto px-6 sm:px-10">
        <div className="text-center mb-16 sm:mb-24">
          <span className="text-rose-700 font-bold uppercase tracking-[0.4em] text-[10px] mb-4 block">Exclusive Collection</span>
          <h2 className="text-4xl sm:text-5xl font-bold text-slate-900 mb-6 uppercase tracking-tight">mosaic tiles for swimming pools</h2>
          <div className="w-16 h-1 bg-rose-900 mx-auto mb-8"></div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 sm:gap-12">
          {products.map((p, idx) => (
            <div key={idx} className={`group bg-white rounded-sm border ${p.featured ? 'border-rose-200' : 'border-slate-100'} shadow-sm overflow-hidden flex flex-col transition-all duration-700 hover:shadow-2xl hover:-translate-y-2`}>
              <div className="relative aspect-square overflow-hidden bg-slate-100">
                ...
                <div className="absolute top-6 left-6 flex flex-col gap-2">
                  ...
                  {p.featured && (
                    <div className="bg-rose-900 px-3 py-1.5 rounded-sm shadow-lg shadow-rose-900/30">
              ...
              <div className="p-8 sm:p-10 flex flex-col flex-grow">
                <h3 className="text-2xl font-bold text-slate-900 uppercase tracking-tight mb-3 group-hover:text-rose-700 transition-colors">{p.name}</h3>
                ...
                <div className="flex items-center justify-between mt-auto pt-8 border-t border-slate-50">
                  <div className="flex flex-col">
                    <span className="text-[10px] font-bold text-rose-700 uppercase tracking-[0.2em] mb-1">Status</span>
        ...
        <div className="mt-20 text-center">
          ...
          <a href="#contact" className="inline-block text-rose-700 font-bold text-xs uppercase tracking-[0.3em] border-b-2 border-rose-100 pb-1 hover:border-rose-900 transition-all">
