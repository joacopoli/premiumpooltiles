        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          <div className="col-span-1 md:col-span-1">
            <div className="flex items-center space-x-2 mb-6">
              <div className="w-8 h-8 bg-cyan-500 rounded-full flex items-center justify-center">
                 <svg viewBox="0 0 24 24" fill="white" className="w-5 h-5"><path d="M12 21.5C12 21.5 4 14 4 9.5C4 5.08172 7.58172 1.5 12 1.5C16.4183 1.5 20 5.08172 20 9.5C20 14 12 21.5 12 21.5Z"/></svg>
              </div>
          ...
          <div>
            ...
            <div className="mt-8">
              ...
              <div className="flex">
                <input type="email" placeholder="Email" className="bg-slate-900 border border-white/10 px-4 py-2 text-sm focus:outline-none focus:border-cyan-500 w-full" />
