        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href="https://www.instagram.com/premiumpooltiles/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center hover:bg-cyan-500 hover:border-cyan-500 transition-all">
            ...
            <div className="mt-4">
              <a href="mailto:Sales@premiumpooltiles.com" className="text-sm text-slate-400 hover:text-cyan-400 transition-colors font-light">
