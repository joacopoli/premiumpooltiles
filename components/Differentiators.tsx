...
const Differentiators: React.FC = () => {
  return (
    <section className="py-24 bg-slate-900 text-white relative overflow-hidden">
      <div className="absolute top-0 right-0 w-1/3 h-full bg-rose-900/5 -skew-x-12 translate-x-1/2"></div>
      
      <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
        <div className="max-w-3xl mx-auto">
          <div className="text-rose-700 mb-8 flex justify-center">
          ...
          <div className="w-16 h-px bg-rose-700 mx-auto mb-10"></div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-left">
            <div>
              <h3 className="text-rose-700 font-bold mb-4 uppercase tracking-widest text-sm">Discipline</h3>
            ...
            <div>
              <h3 className="text-rose-700 font-bold mb-4 uppercase tracking-widest text-sm">Service</h3>
            ...
            <div>
              <h3 className="text-rose-700 font-bold mb-4 uppercase tracking-widest text-sm">Value</h3>
